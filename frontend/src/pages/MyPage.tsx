...
import {
  ...
  Modal, ModalOverlay, ModalCloseButton, ModalBody, ModalHeader,
  Input, Spinner,
  ...
  return (
    <VStack gap="lg" align="stretch">
      ...
      <Box>
        ...
        {loadingFriends ? (
          <Flex justify="center" py="md"><Spinner size="sm" /></Flex>
        ) : friends.length === 0 ? (
          <Box
            bg="gray.50"
            p="md"
                ...
                {searchResults.map((u) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      isDisabled={isAlreadyFriend(u.id)}
